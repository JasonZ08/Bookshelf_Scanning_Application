...
def openFile():
    ...
    yscrollbar = tk.Scrollbar(frame4)
    inputtxt = Text(frame4, height=10, width=25, yscrollcommand=yscrollbar.set)
    inputtxt.pack(side='left', fill='both')
    yscrollbar.pack(side='right', fill='y')
    yscrollbar.config(command=inputtxt.yview)
    frame4.pack(side='right', padx=15)
    ...
    label1 = tk.Label(frame3, image=img)
    label1.pack(side='left', padx=15)
    label1.image = img
    frame3.grid(row=0, column=0)

    root2 = tk.Tk()
    canvas = tk.Canvas(root2, borderwidth=0, background="#ffffff")
    frame = tk.Frame(canvas, background="#ffffff")
    vsb = tk.Scrollbar(root2, orient="vertical", command=canvas.yview)
...
if count == 1:
    ...
    button = tk.Button(frame1, textvariable=textName, font='Raleway', height=1, width=15, command=printState)
    textName.set("Snapshot")

    textName2 = tk.StringVar()
    button2 = tk.Button(frame2, textvariable=textName2, font='Raleway', height=1, width=15, command=retake)
    textName2.set("Retake")
    ...
    button4 = tk.Button(frame2, textvariable=textName3, font='Raleway', height=1, width=15, command=on_closing)
    textName3.set("Quit")
    button2.pack(side='left', padx=10)
    button4.pack(side='right', padx=10)

    button5 = tk.Button(frame2, textvariable=textName4, font='Raleway', height=1, width=15,
                        command=lambda: newWindow2())
...
if count == 2:
    ...
    button1 = tk.Button(frame1, textvariable=textName1, font='Raleway', height=1, width=15, command=openFile)
    ...
    label1 = tk.Label(frame3, height=20, width=37)
    label1.pack(side='left', padx=15)
    frame3.grid(row=0, column=0)
    root.mainloop()
