...
def back1():
    ...
    canvasUpload1.create_image((600, 300), image=mySnapPic, anchor='center', tag='snapScan')
...
def motion1(event):
    ...
    for z in coordArray:
        x1, y1, width, height = z[1], z[2], z[3], z[4]
        if (x1 - width / 2) + (600 - canvasUpload1.image.width() / 2)< x < (x1 + width / 2) + (600 - canvasUpload1.image.width() / 2) \
                and (y1 - height / 2)  + (300 - canvasUpload1.image.height() / 2) < y < (y1 + height / 2) + (300 - canvasUpload1.image.height() / 2):
            possBox.append(z)
    if possBox:
...
def displayPic(myNum):
    def search():
        ...
        if description:
            canvasUpload.create_text(250, 500, text = 'Description:', font = ("Arial", 15), anchor = 'nw', tag = 'result')
            canvasUpload.create_text(250, 525, text=description.text, font=("Arial", 10), anchor='nw',
                                 tag='result', width = 600)
        else:
            canvasUpload.create_text(250, 50, text='No Description Found', font=("Arial", 15), anchor='nw', tag='result')
        title = attributes[attributes.index("Title") + 5:attributes.index("Author")]
        canvasUpload.create_text(250, 50, text='Title:', font=("Arial", 15), anchor='nw', tag='result')
        canvasUpload.create_text(250, 75, text=title, font=("Arial", 10), anchor='nw',
                                 tag='result', width=600)
        author = attributes[attributes.index("Author") + 6:attributes.index("Publisher")]
        canvasUpload.create_text(250, 125, text='Author:', font=("Arial", 15), anchor='nw', tag='result')
        canvasUpload.create_text(250, 150, text=author, font=("Arial", 10), anchor='nw',
                                 tag='result', width=600)
        publisher = attributes[attributes.index("Publisher") + 9:attributes.index("ISBN")]
        canvasUpload.create_text(250, 200, text='Publisher:', font=("Arial", 15), anchor='nw', tag='result')
        canvasUpload.create_text(250, 225, text=publisher, font=("Arial", 10), anchor='nw',
                                 tag='result', width=600)
        isbn = attributes[attributes.index("ISBN") + 4:attributes.index("Length")]
        canvasUpload.create_text(250, 275, text='ISBN:', font=("Arial", 15), anchor='nw', tag='result')
        canvasUpload.create_text(250, 300, text=isbn, font=("Arial", 10), anchor='nw',
                                 tag='result', width=600)
        length = attributes[attributes.index("Length") + 6:attributes.index("Subjects")]
        canvasUpload.create_text(250, 350, text='Length:', font=("Arial", 15), anchor='nw', tag='result')
        canvasUpload.create_text(250, 375, text=length, font=("Arial", 10), anchor='nw',
                                 tag='result', width=600)
        genre = attributes[attributes.index("Subjects") + 8:attributes.index("Export")]
        canvasUpload.create_text(250, 425, text='Subjects:', font=("Arial", 15), anchor='nw', tag='result')
        canvasUpload.create_text(250, 450, text=genre, font=("Arial", 10), anchor='nw',
                                 tag='result', width=600)
    ...
    buttonSub = tk.Button(root2, text = 'Submit', font='Raleway', height=1, width=15, command = search, underline = 0)
    canvasUpload.create_window(600, 275, anchor = 'center', window = buttonSub, tag = 'search')
    root2.bind("<Alt-s>", lambda event: search())
...
def displayPic1(myNum):
    def search():
        ...
        attributes = soup.find("div", {'id': 'metadata_content'}).text
        if description:
            canvasUpload1.create_text(250, 500, text='Description:', font=("Arial", 15), anchor='nw', tag='result')
            canvasUpload1.create_text(250, 525, text=description.text, font=("Arial", 10), anchor='nw',
                                     tag='result', width=600)
        else:
            canvasUpload1.create_text(250, 50, text='No Description Found', font=("Arial", 15), anchor='nw',
                                     tag='result')
        title = attributes[attributes.index("Title") + 5:attributes.index("Author")]
        canvasUpload1.create_text(250, 50, text='Title:', font=("Arial", 15), anchor='nw', tag='result')
        canvasUpload1.create_text(250, 75, text=title, font=("Arial", 10), anchor='nw',
                                 tag='result', width=600)
        author = attributes[attributes.index("Author") + 6:attributes.index("Publisher")]
        canvasUpload1.create_text(250, 125, text='Author:', font=("Arial", 15), anchor='nw', tag='result')
        canvasUpload1.create_text(250, 150, text=author, font=("Arial", 10), anchor='nw',
                                 tag='result', width=600)
        publisher = attributes[attributes.index("Publisher") + 9:attributes.index("ISBN")]
        canvasUpload1.create_text(250, 200, text='Publisher:', font=("Arial", 15), anchor='nw', tag='result')
        canvasUpload1.create_text(250, 225, text=publisher, font=("Arial", 10), anchor='nw',
                                 tag='result', width=600)
        isbn = attributes[attributes.index("ISBN") + 4:attributes.index("Length")]
        canvasUpload1.create_text(250, 275, text='ISBN:', font=("Arial", 15), anchor='nw', tag='result')
        canvasUpload1.create_text(250, 300, text=isbn, font=("Arial", 10), anchor='nw',
                                 tag='result', width=600)
        length = attributes[attributes.index("Length") + 6:attributes.index("Subjects")]
        canvasUpload1.create_text(250, 350, text='Length:', font=("Arial", 15), anchor='nw', tag='result')
        canvasUpload1.create_text(250, 375, text=length, font=("Arial", 10), anchor='nw',
                                 tag='result', width=600)
        genre = attributes[attributes.index("Subjects") + 8:attributes.index("Export")]
        canvasUpload1.create_text(250, 425, text='Subjects:', font=("Arial", 15), anchor='nw', tag='result')
        canvasUpload1.create_text(250, 450, text=genre, font=("Arial", 10), anchor='nw',
                                 tag='result', width=600)
    ...
    canvasUpload1.create_image((175, 300), image=imgtk, anchor='center', tag = 'chosen')
    canvasUpload1.image = imgtk
    textNamecu1 = tk.StringVar()
    buttonc1 = tk.Button(root1, textvariable=textNamecu1, font='Raleway', height=1, width=15, command=back1, underline = 0)
    textNamecu1.set('Back')
    buttoncu1_window = canvasUpload1.create_window(1025, 100, anchor='center', window=buttonc1, tag='back')
    ...
    # authorText = tk.Text(root2, height=3, width=50)
    # canvasUpload.create_window(450, 250, anchor='nw', window=authorText, tag='back')
    buttonSub = tk.Button(root1, text='Submit', font='Raleway', height=1, width=15, command=search, underline = 0)
    canvasUpload1.create_window(600, 275, anchor='center', window=buttonSub, tag='search')
    root1.bind("<Alt-s>", lambda event: search())
...
def printState():
    ...
    canvasUpload1.create_image((600, 300), image=img, anchor='center', tag='snapScan')
...
def retake():
    ...
    canvasUpload1.delete('search')
    canvasUpload1.delete('result')
    canvasUpload1.create_window((600, 300), anchor='center', window=label1, tag='init')
    show_frames()
...
if count == 1:
    ...
    buttonr1 = tk.Button(root1, textvariable=textName, font='Raleway', height=1, width=15, command=printState, underline = 0)
    textName.set("Snapshot")
    canvasUpload1.create_window((175, 630), anchor = 'center', window = buttonr1)

    textName3 = tk.StringVar()
    button3r1 = tk.Button(root1, textvariable=textName3, font='Raleway', height=1, width=15, command=on_closing, underline = 0)
    textName3.set("Quit")
    canvasUpload1.create_window((1025, 630), anchor='center', window=button3r1)
    ...
    canvasUpload1.create_window((600, 630), anchor='center', window=button6)
...
if count == 2:
    ...
    button1up = tk.Button(root2, textvariable=textName1, font='Raleway', height=1, width=15, command=openFile, underline = 0)
    button1_window = canvasUpload.create_window(1000, 100, anchor = 'nw', window = button1up)
    textName1.set("Choose a File")

    textName3 = tk.StringVar()
    button3up = tk.Button(root2, textvariable=textName3, font='Raleway', height=1, width=15, command=on_closing2, underline = 0)
    textName3.set("Quit")
